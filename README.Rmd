...
`get_aggregate_cong_data`: Choose how to aggregate the member-year data into member-session data across subsets (e.g. data sources) of Congress Data. You can choose either `Mean` or `Sum` or `First` (meaning first year in the session value) to aggregat the following chunks of the dataset:
